...
export LDFLAGS_GENERATE="-O3 -march=native -mtune=native -falign-functions=32 -flimit-function-alignment -fno-semantic-interposition -fno-stack-protector -fuse-ld=bfd -fuse-linker-plugin -malign-data=cacheline -mtls-dialect=gnu2 -fno-math-errno -fno-trapping-math -pipe -ffat-lto-objects -fPIC -Wl,--whole-archive /usr/lib64/libidn2.a /usr/lib64/libunistring.a /usr/lib64/libtasn1.a /usr/lib64/libnettle.a /usr/lib64/libhogweeda /usr/lib64/libgmp.a -Wl,--no-whole-archive $PGO_GEN"
## pgo use
...
export LDFLAGS_USE="-g -O3 -march=native -mtune=native -fgraphite-identity -Wall -Wl,--as-needed -Wl,--build-id=sha1 -Wl,--enable-new-dtags -Wl,--hash-style=gnu -Wl,-O2 -Wl,-z,now -Wl,-z,relro -falign-functions=32 -flimit-function-alignment -fasynchronous-unwind-tables -fdevirtualize-at-ltrans -floop-nest-optimize -fno-math-errno -fno-semantic-interposition -fno-stack-protector -fno-trapping-math -ftree-loop-distribute-patterns -ftree-loop-vectorize -ftree-vectorize -funroll-loops -fuse-ld=bfd -fuse-linker-plugin -malign-data=cacheline -feliminate-unused-debug-types -fipa-pta -flto=16 -fno-plt -mtls-dialect=gnu2 -Wl,-sort-common -Wno-error -Wp,-D_REENTRANT -pipe -ffat-lto-objects -Wl,--whole-archive /usr/lib64/libidn2.a /usr/lib64/libunistring.a /usr/lib64/libtasn1.a /usr/lib64/libnettle.a /usr/lib64/libhogweeda /usr/lib64/libgmp.a -Wl,--no-whole-archive -fPIC $PGO_USE"
export AR=gcc-ar
