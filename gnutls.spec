...
#
# package verified with key 0x9D5EAAF69013B842
#
Name     : gnutls
Version  : 3.4.16
Release  : 33
...
%prep
%setup -q -n gnutls-3.4.16
pushd ..
cp -a gnutls-3.4.16 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1483232870
