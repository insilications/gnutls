...
#
# Source0 file verified with key 0x29EE58B996865171 (nmav@gnutls.org)
#
Name     : gnutls
Version  : 3.6.13
Release  : 64
URL      : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.6/gnutls-3.6.13.tar.xz
Source0  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.6/gnutls-3.6.13.tar.xz
Source1  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.6/gnutls-3.6.13.tar.xz.sig
...
%prep
%setup -q -n gnutls-3.6.13
cd %{_builddir}/gnutls-3.6.13
%patch1 -p1
%patch2 -p1
pushd ..
cp -a gnutls-3.6.13 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585937947
...
cp %{_builddir}/gnutls-3.6.13/LICENSE %{buildroot}/usr/share/package-licenses/gnutls/1f511bc8132f3904e090af21d25ef3453314b910
cp %{_builddir}/gnutls-3.6.13/doc/COPYING %{buildroot}/usr/share/package-licenses/gnutls/0dd432edfab90223f22e49c02e2124f87d6f0a56
cp %{_builddir}/gnutls-3.6.13/doc/COPYING.LESSER %{buildroot}/usr/share/package-licenses/gnutls/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/gnutls-3.6.13/doc/examples/tlsproxy/LICENSE %{buildroot}/usr/share/package-licenses/gnutls/06407f2dacc5ba7cbae1b6120c6a57379969a6f3
cp %{_builddir}/gnutls-3.6.13/lib/accelerated/x86/license.txt %{buildroot}/usr/share/package-licenses/gnutls/54c70759aa4b060ff33b7412fa6f38480fc840b2
cp %{_builddir}/gnutls-3.6.13/lib/inih/LICENSE.txt %{buildroot}/usr/share/package-licenses/gnutls/d097282eb6f05d825f591cef06bac3654b58feba
cp %{_builddir}/gnutls-3.6.13/src/libopts/COPYING.gplv3 %{buildroot}/usr/share/package-licenses/gnutls/a8573c5c670d8a150d41fbde33d79e8e49d2a9fa
cp %{_builddir}/gnutls-3.6.13/src/libopts/COPYING.lgplv3 %{buildroot}/usr/share/package-licenses/gnutls/8ca3cbd336e9a13d5ee05753567d9261af4066a3
cp %{_builddir}/gnutls-3.6.13/src/libopts/COPYING.mbsd %{buildroot}/usr/share/package-licenses/gnutls/76f15ccf78ed039d563200c8db64f85d17c3d7cb
pushd ../build32/
%make_install32
...
/usr/lib64/libgnutls.so.30.27.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgnutls.so.30
/usr/lib32/libgnutls.so.30.27.0
